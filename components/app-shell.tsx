...
import { Bell, ChevronDown, ChevronsLeft, ChevronsRight, LogOut, Menu, Search, X } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background">
      <aside className={`fixed inset-y-0 left-0 z-30 hidden border-r bg-[#09151e] transition-[width] lg:flex lg:flex-col ${sidebarCollapsed ? 'w-20' : 'w-64'}`}>
        <div className={`flex h-20 items-center border-b ${sidebarCollapsed ? 'justify-center px-3' : 'px-6'}`}>
